...
> Automatic schema detection that creates the migrations for your _Go_ project.
...
To install this project on your machine you should have _Go_ installed in your machine, if not follow this [official step](https://go.dev/doc/install) and install it in your machine.
